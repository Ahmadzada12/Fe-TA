      ...
      >
        ...
        >
          ...
          >
            ...
            <div
              class="self-stretch h-px border-t-[1px] border-solid border-gray-1000"
            />
            <div
            ...
            >
              ...
              <div
                class="self-stretch rounded-sm bg-white box-border overflow-hidden border-[1px] border-solid border-lightgray-100"
              >
                <textarea
          ...
          <div
            v-if="errorMessage"
            class="w-full p-3 my-2 text-sm text-red-700 bg-red-100 rounded-lg"
            role="alert"
          >
          ...
          >
            <div
              v-if="!isLoading"
              class="relative text-mini-4 leading-[22px] font-medium font-poppins text-white text-center"
            >
              Donasi Sekarang
            </div>
            <div
              v-if="isLoading"
              class="relative text-mini-4 leading-[22px] font-medium font-poppins text-white text-center flex items-center"
            >
              <svg
  ...
  setup() {
    ...
    const createInvoice = async () => {
      ...
      try {
        ...
        if (response.data && response.data.invoiceUrl) {
          ...
          errorMessage.value =
            "Gagal membuat invoice. URL pembayaran tidak ditemukan.";
        ...
        if (error.response?.data?.message) {
          ...
          errorMessage.value =
            "Gagal memproses donasi Anda. Silakan coba beberapa saat lagi.";
        }
    ...
    const onUbahClick = (currentDonationId: string) => {
      if (currentDonationId) {
        // Kirim nominal saat ini sebagai query parameter
        router.push({
          path: `/pilih-nominal-donasi/${currentDonationId}`,
          query: { nominal: nominal.value.toString() },
        });
      } else {
        errorMessage.value =
          "Gagal mengubah nominal, ID donasi tidak ditemukan.";
